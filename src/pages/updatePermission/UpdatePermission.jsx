...
function UpdatePermission() {
    ...
    const [alignment, setAlignment] = React.useState('izin');
    ...
    const { handleSubmit, getFieldProps, errors, touched } = useFormik({
        ...
        // }),
        onSubmit: (values) => {
            AttendRequest.updatePermit(alignment,values, handleOpenModal);
            setAlignment('izin')
        },
                                        ...
                                        <div className="md:w-96 sm:w-80 py-3 ">
                                            ...
                                            <div className="font-sans text-abuabuSecondary text-xl font-medium ">
                                                <ToggleButtonGroup
                                                    ...
                                                    name="permit"
                                                >
                                                    <ToggleButton value="izin" aria-label="left aligned">
                                                        Izin
                                                            </ToggleButton>
                                                    <ToggleButton value="libur" aria-label="centered">
                                                        Libur
                                                            </ToggleButton>
                                                </ToggleButtonGroup>
                                            </div>
                                            ...
                                            <div className="md:mt-60 sm:mt-5">
