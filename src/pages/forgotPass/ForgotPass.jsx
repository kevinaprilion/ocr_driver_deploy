                ...
                <div className="mx-auto">
                    <div className="h-full w-full">
                        ...
                        <div className="flex flex-col justify-start ml-5 mt-5 ">
                            ...
                            <div className="font-sans text-black text-xl font-medium mt-5">
                                Masukkan username anda lalu cek email anda.
                                atau hubungi call center OCR Indo.
                        </div>
                            <div className="font-normal font-sans text-abuabuPrimary text-sm float-left mt-2">
                                <PhoneInTalkIcon fontSize="small" /> 021-8393843 <MailIcon fontSize="small" className="ml-2" />help@ocrindo.com
                        </div>
                        </div>
